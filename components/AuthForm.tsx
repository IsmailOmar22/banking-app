    ...
    <section className='auth-form'>
      <header className='flex flex-col gap-5 md:gap-8'>
        ...
        <div className='flex flex-col gap-1 md:gap-3'>
            <h1 className='text-24 lg:text-36 font-semibold text-grey-900'>
                ...
                <p className='text-16 font-norml text-grey-600'>
      ...
      <Form {...form}>
        ...
        <footer className='flex justify-center gap-1'>
            <p className='text-14 font-normal text-grey-600'>{type === 'sign-in' ? "Don't have an account?" : "Already have an account?"}</p>
